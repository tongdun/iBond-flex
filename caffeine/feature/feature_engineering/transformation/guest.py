...
from .binning.hetero_binning.dtbinning.guest import HeteroDtBinGuest
from .mapping.hetero_mapping.woe_mapping.guest import HeteroMapToWOEGuest
...
TRANSFORM_METHODS =  {
    'hetero': {
        'dt_bin': HeteroDtBinGuest,
        'woe_map': HeteroMapToWOEGuest
    },
    'homo':{
        # TODO
    },
...
class FeatureTransformGuest(FeatureTransformBase):
    @ClassMethodAutoLog()

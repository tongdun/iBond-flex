...
from flex.constants import CRYPTO_PAILLIER, CRYPTO_AES, \
    CRYPTO_ONETIME_PAD, CRYPTO_SECRET_SHARING, CRYPTO_SM4, CRYPTO_RSA
...
class EncryptModel:
    ...
    def __init__(self, method: Optional[str] = None,
        ...
        **Example**:
        ...
        # init encrypt
        encrypt_method = {
            CRYPTO_RSA: self._generate_rsa_keypair,
    ...
    def _generate_rsa_keypair(self) -> Tuple[object, object]:
        """
        Generate rsa public key/private key
        """
        # rsa_pubkey, rsa_prikey = rsa.newkeys(self.key_length,
        #                                      poolsize=multiprocessing.cpu_count())
        rsa_pubkey, rsa_prikey = rsa.newkeys(self.key_length)
        return rsa_pubkey, rsa_prikey

...
class SSComputeGuest(BaseModel, Mixin):
    """
    FMC Protocol implementation for guest
    """
    ...
    def __init__(self,
        ...
        """
        Initlizatte SSComputeGuest class
        ...
        Returns:
            SSComputeGuest: the SSCompute protocol instance for guest
        """
    ...
    def pre_process_data(self,
        ...
        ret = make_fixed_precision_tensor(vec, self.smpc.precision)
        return ret

...
CRYPTO_KEY_LENGTH = [CRYPTO_RSA, CRYPTO_PAILLIER, CRYPTO_SM4, CRYPTO_AES, CRYPTO_ECC, CRYPTO_ONETIME_PAD]
...
# RSA Secure Alignment
RSA_SAL = 'rsa_sal'

# Elliptic Curve Diffie-Hellman Secure Alignment
ECDH_SAL = 'ecdh_sal'
